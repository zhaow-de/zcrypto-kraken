...
# segments, then pulls the engine journal (--no-verify: no .sha256 sidecars, Role B verifies it
# via replay). The loop itself is the availability guarantee: a single
