...
# Per-machine deploy keys (2026-07-16): one vaulted private per ansible-managed host.
for k in files/deploy_zcrypto_ed25519 files/deploy_zcrypto-red_ed25519 files/deploy_zcrypto-ops_ed25519; do
