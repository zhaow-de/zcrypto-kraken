...
# stopped timer freezes BOTH and the exit code goes on reporting the last clean cycle's zero. Same
# operand and bound as the dead-man rule (alerts.yaml, uid zcrypto-ops-archive-pull-stalled).
