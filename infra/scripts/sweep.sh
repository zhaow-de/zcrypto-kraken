...
# Every other word goes to grep unexamined, its operands riding along in place; a pattern spelt any other way
# records none here and reaches a refusal naming the spelling that works.
control=0
known=""
