...
- Converges via `infra/ansible/scripts/converge.sh`: the invariants are `.claude/rules/fleet-deploys.md`'s, the mechanics this file's *Shared converge mechanics*.
