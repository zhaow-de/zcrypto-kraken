...
if (!entries.some((e) => e.kind === 'pre-review' && (sameTip(e) || e.treeEqualsTip === true))) throw new Error(`re-review refuses ${tip}: ${ledgerPath} records no pre-review of this tip — run pre-review on the fix range first`)
