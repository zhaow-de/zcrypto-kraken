...
- **Amend `Reviewed-by:` in the same turn the review returns, before starting anything else** — an un-trailered review is invisible and gets re-run, paying for the same review twice. The trailer is part of the review step, not of the push.
