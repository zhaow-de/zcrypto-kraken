...
compared to the single-asset BTC B0/B1 benchmarks from `docs/research/04.phase3-benchmark-b0-b1-report.md` over the
*same* window.
...
basket use the same 30-day lookback and a 10%/yr target vol (`vol_target(..., target_vol=0.10 / 365**0.5, lookback=30, max_leverage=1.0)`), consistent with the rest of the family.
...
versus **1.075 over BTC's full 2013–2026 history** (`docs/research/04.phase3-benchmark-b0-b1-report.md`) — the common
...
the whole family (Sharpe 1.247, `docs/research/04.phase3-benchmark-b0-b1-report.md`).
...
Same method as `docs/research/04.phase3-benchmark-b0-b1-report.md`, scaled to this shorter window: 95% confidence
