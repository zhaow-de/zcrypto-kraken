...
- **Design and plan**: `docs/specs/00011-perf-metrics-design.md`, `docs/plans/00011-perf-metrics.md`, which record sortino/Calmar as YAGNI and returns-from-prices and benchmark-relative deltas as non-goals (returns-from-prices built since as `returns_from_prices`, iter-026).
