...
| #47 | 2026-07-08 | feat(tick): iter-39 — tick-derived bar reconciliation + true VWAP | iter-039 | — | T0004 |
...
| #51 | 2026-07-08 | feat(tick): iter-42 — complete-dataset reader + full-history BTC/EUR rec | iter-042 | — | T0004 |
...
| #62 | 2026-07-09 | feat(benchmark): iter-44 — full-history dynamic-composition basket + fin | iter-044 | — | T0007 |
...
| #117 | 2026-07-12 | feat(config): iter-094 — Role B (NAS gate-verify + telemetry) | iter-094 | — | — |
...
| #127 | 2026-07-14 | feat(infra): iter-096 — Role C redundant capture (spec 00050) (1 of 2) | iter-096 | 00050 | — |
...
| #168 | 2026-07-20 | test(cli): iter-112 — pin the gate-evidence guarantees and make fingerpr | iter-112 | 00064 | T0075 |
...
| #185 | 2026-07-22 | feat(universe): iter-115 — retire the spread_cap placeholder with a cali | iter-115 | — | T0024 |
...
| #191 | 2026-07-22 | feat(obs): iter-117 — app /metrics endpoints, process self-metrics, no c | iter-117 | 00069 | — |
...
| #212 | 2026-07-27 | feat(capture): prove the reconnect path runs, then make desync recovery | — | — | T0008 |
| #213 | 2026-07-27 | feat(capture): see a stream that is connected, subscribed, and silent | — | — | T0101 |
...
| #224 | 2026-07-28 | fix(panel): the generation guard checks the tree, not just its manifest | — | — | T0104 |
| #226 | 2026-07-29 | fix(config): mount the alloy config directory, so a config change reache | — | — | T0109 |
| #227 | 2026-07-29 | fix(config): the alloy config that never reached the process — and the s | — | — | T0109 |
...
| #248 | 2026-08-02 | feat(cli): iter-119 — wire the §10 whole-book limits, ZEUR spot reportin | iter-119 | — | T0120, T0121, T0122 |
...
| #258 | 2026-08-03 | feat(config): iter-124 — converge discipline becomes refusable: wave-1 g | iter-124 | — | T0111 |
| #259 | 2026-08-03 | docs(reference): record the iter-119 T+24h RSS re-read — flat on both ho | iter-119 | — | — |
| #260 | 2026-08-04 | feat(config): iter-125 — the converge path becomes refusable: wave-2 scr | iter-125 | — | T0111 |
...
| #272 | 2026-08-06 | feat(grafana): iter-127 — the rollout: boards, rules and all four conver | iter-127 | — | T0020 |
| #273 | 2026-08-06 | feat(capture): iter-129 — resolve the venue pre-drain decision from its | iter-129 | — | T0105 |
| #276 | 2026-08-08 | feat(cli): iter-131 — the quote-aware notional ladder and the /BTC sprea | iter-131 | — | T0092 |
...
| #282 | 2026-08-10 | feat(registry): iter-133 — dataset provenance is the bytes the run read, | iter-133 | — | T0065 |
| #283 | 2026-08-10 | docs(open_topics): T0085 owns the nautilus bump, its real-money probe an | — | — | T0085 |
| #285 | 2026-08-10 | feat(tick): iter-134 — tape-bars, 15m bars from the captured trade tape | iter-134 | — | T0065 |
| #288 | 2026-08-11 | feat(engine): iter-135 — the execution safety envelope | iter-135 | — | T0018 |
| #289 | 2026-08-12 | docs(reference): pin the fleet to 6c5151d9f3af — spec 00088's execution | — | 00088 | — |
| #290 | 2026-08-12 | feat(data): iter-136 — the universe refresh's volume source reaches the | iter-136 | — | T0093 |
| #291 | 2026-08-13 | feat(grafana): alert on a repeat venue degradation the latch cannot repo | — | — | T0135 |
| #293 | 2026-08-13 | feat(universe): iter-137 — the attended refresh, and the legacy fallback | iter-137 | — | T0093 |
| #294 | 2026-08-14 | feat(engine): iter-138 — venue truth: the instrument map, constraint siz | iter-138 | — | T0018 |
| #295 | 2026-08-14 | docs(open-topics): resolve T0136 — the capture bake's RSS residual conve | — | — | T0136 |
| #297 | 2026-08-15 | feat(engine): iter-139 — the /BTC widening: a twelve-leg symbol-keyed pi | iter-139 | — | T0137 |
...
| #306 | 2026-08-20 | feat(archive): iter-141 — a venue-silence discriminator for the residual | iter-141 | — | T0143 |
...
| #317 | 2026-08-22 | feat(engine): iter-143 — adopted orders' fills become observable, withou | iter-143 | — | T0142 |
...
| #330 | 2026-08-24 | feat(data): one manifest contract — the zoo is removed rather than read | — | — | T0132 |
| #332 | 2026-08-24 | docs(open_topics): T0151 resolved — the capture RSS step is attributed, | — | — | T0151 |
| #340 | 2026-08-27 | feat(engine): iter-147 — the external-order delivery leg is proven, and | iter-147 | — | T0152 |
| #341 | 2026-08-28 | fix(archive): iter-148 — the reconcile ledger scan is measured, cheaper, | iter-148 | — | T0044 |
| #342 | 2026-08-28 | fix(capture): iter-149 — the capture silence bars survive their re-deriv | iter-149 | — | T0129 |
...
| #346 | 2026-08-29 | feat(archive): iter-152 — bound the NAS pull's verify cost, and measure | iter-152 | — | T0028 |
| #347 | 2026-08-29 | feat(capture): iter-153 — make T0037's accepted residuals observable | iter-153 | — | T0037 |
| #348 | 2026-08-29 | feat(engine): iter-154 — decompose keeps the whole-book limits' share | iter-154 | — | T0121 |
...
| #352 | 2026-08-30 | feat(obs): iter-156 — every alert has a runbook, and a daily pass reads | iter-156 | — | T0157 |
...
| #374 | 2026-09-02 | fix(capture): iter-163 — the past-dated detector counts only a never-cap | iter-163 | — | T0037 |
...
| #462 | 2026-09-09 | feat(engine): iter-169 — the soak's null is judged over the complete-bas | iter-169 | — | T0184 |
