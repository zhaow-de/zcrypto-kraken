...
On merge: append an `iter-002` entry to `docs/iterations-history.md`; add `docs/research/01.kraken-snapshot-register.md` to the mdformat allowlist in the same change.
