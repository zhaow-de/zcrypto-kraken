...
- **B2's shape is fixed by master-plan §5** (Strategy Design Space, line 156 — *not* §12, which begins at line 307 and mentions B2 only in the approval calendar; note §9 line 261 uses "B2" for an unrelated benchmark): *"funding extremes and OI/liquidation spikes as short-horizon de-risking / re-entry triggers for the spot book"* — a **conditioning** family, like B1, not a standalone system.
