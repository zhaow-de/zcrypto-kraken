...
**What had landed before the close**, folded in from this topic's former `## Done so far` — its "the remainder below" is the pair of remainders the paragraph above drops:
