...
The host read the last step asked for was taken 2026-09-21 09:50 UTC: the engine host's store (`/var/lib/zcrypto-engine/store`, 8.2M, 24 parquets) was pulled read-only and compared against the journal record `/mnt/zhao-crypto/engine-journal/2026-09-21/cycle-08.json` (cycle_ts 2026-09-21T08:00:00Z). All 12 `240` legs and all 12 `1440` legs EQUAL: the content hashes match, every journaled close equals the live close at its stamp, no extra or missing stamp at or before `last_ts` (240: 2026-09-21T04:00Z; 1440: 2026-09-20T00:00Z), and zero off-grid stamps on any leg -- which settles spec `00115` D2's equality of the journaled closes with the live store. The copy was deleted after the read.
