...
- The engine's day-1 (2026-07-11) gate cycle was verified **clean through the reboot** — see the Resolution.
...
**Reboot order is settled and recorded in `docs/reference/fleet.md` § Reboots:** secondary first, then primary — the reverse of the image-rollout order, because if the kernel bricks the secondary the primary is never touched.
