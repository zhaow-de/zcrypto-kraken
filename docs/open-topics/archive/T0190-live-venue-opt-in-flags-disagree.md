...
surviving occurrence is a record of what they WERE, in four FILES -- nine occurrences, six of them in this
one -- measured at this resolution with `git grep -l` and `git grep -c`: this file; `docs/plans/00106-engine-flatten.md:4104`, a committed plan;
