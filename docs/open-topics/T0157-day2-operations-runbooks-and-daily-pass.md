...
- Land spec `00104` and its plan; execute: the alert-requires-runbook guard, the 51 sections across the new subsystem files, the instrument, the journal, the skill, and the principle homings above.
