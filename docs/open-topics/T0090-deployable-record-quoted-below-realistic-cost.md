...
- **(open question, no owner yet)** Whether the unreproducibility of trial 43 warrants its own topic — the deployable's adoption criterion is permanently unre-examinable, and nothing currently registers that beyond this bullet.
