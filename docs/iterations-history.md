...
- [Phase 2 — Validation Harness & Cost Model](iterations-history-phase2.md)
- [Phase 3 — Benchmarks & the Bar to Beat](iterations-history-phase3.md)
- [Phase 4 — Alpha Research Sprints](iterations-history-phase4.md)
- [Phase 5 — Portfolio Assembly & Risk Layer](iterations-history-phase5.md)
- [Phase 6 — Execution Engine, Paper Trading & Go-Live](iterations-history-phase6.md)
