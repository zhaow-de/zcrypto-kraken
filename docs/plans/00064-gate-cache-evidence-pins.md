...
- Grounded: `_REPLAY_CODE_PATHS` at `gate_cache.py:54` (ten paths, LIVE/LATENT labels at :55/:62), `load_cache` at :186, the schema check at :196, `save_cache` at :211, `_replay_one` at `command.py:171`, `replayed_ok`/`mismatches` at `command.py:266-267`, `_counted_replay_cycle` at `test_engine_gate_export_cache.py:119`, and the module-scope imports at `crossfreq_system.py:53-56` — all verified present.
