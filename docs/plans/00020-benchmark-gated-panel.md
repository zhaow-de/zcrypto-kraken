...
- No code change — the run uses existing components. The run script is a THROWAWAY scratchpad (not committed); the committed artifact is the updated report. `docs/research/04.phase3-benchmark-b0-b1-report.md` is NOT on the mdformat allowlist — write clean markdown. No CLI/README change.
...
- [ ] **Step 2: Update `docs/research/04.phase3-benchmark-b0-b1-report.md`** — retitle to reflect the BTC panel, and:
