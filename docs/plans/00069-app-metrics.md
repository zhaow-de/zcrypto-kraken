...
- [ ] **Step 5 (primary):** after the bake — `-e converge_primary=true` with both digests; same verification; **five of T0089's six containers now cleared** (the engine completes the set at Step 6 — cold-review M1).
