...
- **`T0000`** — the live fee-tier, the July-9 AoP rule and the rollover bands stay account-gated there; the L2 capture daemon is Phase 1.
...
- **Phase 0's autonomous work ends here** — the remaining exit-bar items are human-gated in `T0000`, and the loop advances to Phase 1 (Data Foundation).
