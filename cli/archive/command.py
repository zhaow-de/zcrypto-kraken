...
def reconcile(
    ...
    min_gap_seconds: float = typer.Option(
        ...
        "coalescing artifact, 1.4x below the smallest real outage on record (a 41 s socket drop).",
    ),
    ...
    are an 83 s reboot and a 270 s WS-503 crash), so it costs no detection power -- and a live 25-minute drill outage healed
