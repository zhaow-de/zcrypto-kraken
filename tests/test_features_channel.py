...
def test_channel_position_known_answer():
    # Hand-computed from `2*(P-lo)/(hi-lo)-1` over the trailing window prices[k-2:k+1], P = prices[k]:
    # k=2 [10,11,12] -> +1.0 at the high; k=3 [11,12,9] -> -1.0 at the low; k=4 [12,9,8] -> -1.0.
...
def test_channel_position_midpoint():
    # P at the exact midpoint of its window: prices[0:3] = [10, 14, 12] -> hi=14, lo=10, P=12 ->
    # 2*(12-10)/(14-10)-1 = 0.0.
